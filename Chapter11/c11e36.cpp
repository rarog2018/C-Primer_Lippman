...
int main(void)
{
    //////////////////////////      ANSWER      /////////////////////////////
    /*
    When the rules file contains a line that has a key but has no rule my 
    program will print "WARNING: no rule for key: [key]" and proceed other 
    words, while the original program will throw an exception and quit.
    */
