...
class StrBlob
{
    // befriend StrBlobPtr and ConstStrBlobPtr
...
public:
    ...
    StrBlobPtr begin();
    StrBlobPtr end();
    // added ConstStrBlobPtr "iterators"
...
public:
    ...
    // add const before StrBlob
    ConstStrBlobPtr(const StrBlob &a, size_t sz = 0) : wptr(a.data), curr(sz) {}

    // member functions
    // add const before string
...
int main(void)
{
    const StrBlob obj{"hello", "world", "mem"};

    ConstStrBlobPtr iter = obj.cbegin();
