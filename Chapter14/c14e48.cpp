...
// It should have a bool conversion to easily determine wheter the object is
// value initialized (empty), or it has actual book data in it (nonempty).
// It should be explicit, to use it according to C++ standard (implicit conversion
// only in conditions).
