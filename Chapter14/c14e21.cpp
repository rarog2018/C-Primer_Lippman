...
// there are some pretty clear disadvantages of defining += with the '+' operator
// the biggest and most obvious is that previously the lines
// mem += rhs.mem;  worked 'in place' with the referenced object without making
// any copies
// while now the line
// *this = *this + rhs;     creates a temporary object 'sum' that does the work
// that previously 'mem += rhs.mem;' were doing and then uses assign operator=
// to store the result of such computation in the *this object
// this approach does more work (more operations) and uses more memory
...
Sales_data operator+(const Sales_data &lhs, const Sales_data &rhs)
{
    ...
    // sum += rhs;
    // return sum;
    // manually update all the necessary members
