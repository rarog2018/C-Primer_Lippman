...
// This class should not define the relational operators, instead it should
// define functions like compareTitle, compareAuthor, comparePageCount and
// comparePrice to determine relations between particular books
