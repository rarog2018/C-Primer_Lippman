...
public:
    ...
    // ADDED: assignment operator that takes a string with ISBN
...
int main(void)
{
    ...
    // new operator= test
    cout << "ISBN before assigning new value: " << ob1.isbn() << endl;

    ob1 = "201-22-1799-Y";
    cout << "ISBN after assigning new value: " << ob1.isbn() << endl;
...
Sales_data &Sales_data::operator=(const string &isbnString)
{
    bookNo = isbnString;
    return *this;
}
