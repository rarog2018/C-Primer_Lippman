...
// This class doesn't need any other assignment operators, because it would be
// unclear what they are supposed to mean f.e. operator=(string &s) means that
// we assign the title or the author?
