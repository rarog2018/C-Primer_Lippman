...
// UPDATED: uses for_each algorithm and a lambda
void StrVec::free()
{
    ...
    if (elements)
    {
        ...
        // I have spent too much time to make this work, struggling with making
        // it run from the last element to first
        // I prefer the for loop, because I understand it better
